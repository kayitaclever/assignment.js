...
function Adults(people){
   const x = people.filter(person=>person.age>=18)
   const adultsNames= x.map(person=>person.name)
  return adultsNames
}
...
const person = [
   ...
   console.log(Adults(person))
    ...
    // groups the products by their categories, with the category names as keys and the arrays of 
    // products as values.
// const products = [
